                    ...
                    <form action="{{ route('tareas.store') }}" id="formu" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="titulo" id="titulo" required
                                   class="w-full mt-1 px-4 py-2 border border-gray-300 dark:border-gray-600 text-white rounded-md bg-gray-100 dark:bg-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-green-500">
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="descripcion" id="descripcion" rows="4"
                                      class="w-full mt-1 px-4 py-2 border text-white border-gray-300 dark:border-gray-600 rounded-md bg-gray-100 dark:bg-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-green-500"
